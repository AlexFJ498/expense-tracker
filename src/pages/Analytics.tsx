  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-4">
        ...
        <KPI title={t("analytics.avgMonthlyExpense")} value={formatEuro(s.avg_monthly_expense)} icon={TrendingDown} tone="negative" />
        <KPI title={t("analytics.avgMonthlyBalance")} value={formatEuroSigned(s.avg_monthly_balance)} icon={Activity} tone={s.avg_monthly_balance >= 0 ? "positive" : "negative"} />
      </div>
